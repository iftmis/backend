package org.tamisemi.iftmis.config.timezone;
...
import org.tamisemi.iftmis.repository.timezone.DateTimeWrapper;
import org.tamisemi.iftmis.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM iftmis_date_time_wrapper where id=%d", fieldName, id);
    }
