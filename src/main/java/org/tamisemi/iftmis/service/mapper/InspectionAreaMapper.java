 ...
 */
@Mapper(componentModel = "spring", uses = { InspectionMapper.class, AuditableAreaMapper.class, InspectionSubAreaMapper.class })
public interface InspectionAreaMapper extends EntityMapper<InspectionAreaDTO, InspectionArea> {
    ...
    @Mapping(source = "auditableArea.id", target = "auditableAreaId")
    @Mapping(source = "auditableArea.name", target = "auditableAreaName")
    @Mapping(source = "inspectionSubAreas", target = "inspectionSubAreas")
    @Named("toDtoWithSubAreas")
    InspectionAreaWithSubAreaDTO toDtoWithSubAreas(InspectionArea inspectionArea);
