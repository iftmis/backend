...
public class SubAreaResource {
    ...
    public ResponseEntity<SubArea> createSubArea(@Valid @RequestBody SubArea subArea) throws URISyntaxException {
    ...
    public ResponseEntity<SubArea> updateSubArea(@Valid @RequestBody SubArea subArea) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subArea.getId().toString()))
            .body(result);
    }
